  ...
  <div>
    ...
    <div class="table">
      <el-table :data="tableData" @selection-change="handleSelectionChange" :header-cell-style="{'text-align':'center'}">
        ...
        <el-table-column prop="id" label="发布人ID" show-overflow-tooltip align="center"></el-table-column>
        <el-table-column prop="userName" label="发布人" show-overflow-tooltip align="center"></el-table-column>
      ...
      <el-form label-width="100px" style="padding-right: 50px" :model="form" :rules="rules" ref="formRef">
        ...
        <el-form-item prop="status" label="物品状态">
          <el-select prefix-icon="el-icon-key" v-model="form.status" placeholder="请选择状态">
            <el-option v-if="form.status === '丢失中'" label="丢失中" value="丢失中"></el-option>
            <el-option v-if="form.status === '未找到失主'" label="未找到失主" value="未找到失主"></el-option>
            <el-option v-if="form.status === '已找到'" label="已找到" value="已找到"></el-option>
            <el-option v-if="form.status === '已找到失主'" value="已找到失主"></el-option>
          </el-select>
        </el-form-item>
