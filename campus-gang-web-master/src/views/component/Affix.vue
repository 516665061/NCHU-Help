          ...
          <el-popover
            ...
            <div style="width: 300px; height: 300px">
              ...
              <div style="display: flex; align-items: center;justify-content: center">
                <img src="@/assets/imgs/binaryCode.png" alt="" style="width: 250px; height: 250px; border: 1px solid rgb(204, 204, 204); border-radius: 10px;">
              </div>
            </div>
