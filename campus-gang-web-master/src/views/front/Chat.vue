<template>
  <div class="main-content">
    <div style="display: flex; grid-gap: 20px">
      ...
      <!-- 聊天组开始 -->
      <div class="chat-card" style="width: 200px; min-height: 500px">
      ...
      <!-- 聊天消息开始 -->
      <div class="chat-card" style="flex: 1; height: 500px">
        <div class="chat-text" id="chat-text-container" style="height: 300px; border-bottom: 1px solid #ddd; overflow-y: auto;">
        ...
        <!-- 聊天输入框开始 -->
        <div style="height: 170px; padding: 5px 10px">
          <el-input type="textarea"  :autosize="{ minRows: 5}" v-model="form.text" style="width: 100%;"></el-input>
  ...
  methods: {
    ...
    loadChatList(chatUserId) {
      ...
      this.$request.get('/chatInfo/selectUserChat/' + chatUserId).then(res => {
        ...
        //跳到最新聊天处
        let chatTextElement = document.getElementById('chat-text-container')
